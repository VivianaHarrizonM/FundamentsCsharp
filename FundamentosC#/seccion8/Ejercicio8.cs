...
namespace FundamentosC_.seccion8
{
    ...
    //        //Instanciar a la colección List
    ...
    //                break;
    //                case 2:
    //                    Console.Write("Ingresa el número del alumno que desea eliminar: ");
    //                    indice = Convert.ToInt32(Console.ReadLine());

    //                    indice--; //Reducimos a 1 a índice, por que el usuario no sabe que el índice empieza en cero por lo tanto, si se ingresa 1, en realidad será 0
    ...
    //                    //Verificar si el elemento(alumno) está o no en la Lista
    //                    if (Alumnos.IndexOf(alumno) >= 0)
    //                    {
    //                        encontarAlum = Alumnos[Alumnos.IndexOf(alumno)]; //Alumnos[3]
    //                        j = Alumnos.IndexOf(alumno) + 1;
    //                        Console.WriteLine("El estudiante {0} se encuentra en el número de lista {1}", encontarAlum, j);
    //                    }
    //                    else
    //                    {
